...
const ActivityCard = ({ activity, assignature, grades }) => {

    const queryClient = useQueryClient()
    // const grades = queryClient.getQueryData([assignature.id])?.data
    const navigate = useNavigate()
    const filteredGrades = filterGradesByActivity(grades, activity)
  ...
  return (
    <div 
        onClick={() => navigate('/activity', { replace: true, state: {activity, assignature}})}
